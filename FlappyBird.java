...
public class FlappyBird extends JPanel implements ActionListener, KeyListener {
	...
	public void draw(Graphics g) {
        ...
        if (gameOver) {
            ...
            y += 50; // Position it below the Game Over message
    ...
    // In the `keyPressed` method, reset the game while preserving the high score.
    @Override
    public void keyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            if (gameOver) {
                ...
                pipes.clear();
                gameOver = false;
                score = 0; // Reset score but keep highScore intact
                gameLoop.start();
                placePipeTimer.start();
            }
        }
